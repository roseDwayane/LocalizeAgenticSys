...
async function buildContainerArgs(
  ...
  //
  // Skipped entirely under the native-credential proxy opt-out: credentials
  // already came from `.env` via nativeCredentialEnvArgs() above, so there is
  // no vault to wire and OneCLI need not be running.
